...
const NurseFounder = () => {
  ...
  const groupedMembers = chunkArray(nurseteamMembers, itemsPerSlide);

  return (
    <section className="py-5" id='nursetestimonials'>
      <Container>
        ...
        <Carousel controls indicators={true} interval={5000} pause="hover">
