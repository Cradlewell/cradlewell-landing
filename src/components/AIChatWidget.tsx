...
function SpeedDial({ onOpenAria, isMobile }: { onOpenAria: () => void; isMobile: boolean }) {
    ...
    const subBtnBase: React.CSSProperties = {
        ...
        border: "none",
        padding: 0,
        animation: "speedDialIn 0.22s ease forwards",
    };
        ...
        <div style={{ display: "flex", flexDirection: "column", alignItems: "flex-end", gap: 14 }}>
            {expanded && (
                <>
                    {/* WhatsApp */}
                    <button
                        style={{ ...subBtnBase, animationDelay: "0.04s" }}
                        onClick={() => { window.open("https://wa.me/919363893639", "_blank"); }}
                        aria-label="Chat on WhatsApp"
                    >
                        <span style={label("WhatsApp")}>WhatsApp</span>
                        <div style={iconCircle("#25D366")}>
                    ...
                    {/* Aria */}
                    <button
                        style={{ ...subBtnBase, animationDelay: "0s" }}
                        onClick={() => { setExpanded(false); onOpenAria(); }}
            ...
            <button
                ...
                aria-label={expanded ? "Close options" : "Contact us"}
                style={{
                    width: 60,
                    height: 60,
                    borderRadius: "50%",
                    ...
                    justifyContent: "center",
                    flexShrink: 0,
                    animation: expanded ? "none" : "ariaPulse 2.5s infinite",
    ...
    return (
        <>
            ...
            >
                ...
                {/* Speed-dial */}
                {!isOpen && (
                    <SpeedDial onOpenAria={() => setIsOpen(true)} isMobile={isMobile} />
                )}
