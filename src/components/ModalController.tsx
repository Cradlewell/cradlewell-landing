...
const defaultForm = {
  ...
  birthStageStatus: '', babyAge: '', currentWeight: '', address: '',
  shiftType: '', shiftHours: '', shiftTime: '', careStartDate: '', serviceDays: '',
};
...
const ModalController = () => {
  ...
  const closeModal = () => { setShowModal(false); setSubmitted(false); setForm(defaultForm); };
  ...
  const handleChange = (e: React.ChangeEvent<HTMLInputElement | HTMLSelectElement | HTMLTextAreaElement>) => {
    ...
    setForm(prev => {
      ...
      if (name === 'service' || name === 'shiftType') { next.shiftHours = ''; next.shiftTime = ''; }
    ...
    try {
      const res = await fetch('/api/lead', {
        ...
        body: JSON.stringify({
          ...
          babyStatus: form.babyStatus, hospitalName: form.hospitalName,
          birthStageStatus: form.birthStageStatus, babyAge: form.babyAge,
          currentWeight: form.currentWeight, address: form.address,
          shiftType: form.shiftType, shiftHours: form.shiftHours,
        ...
        <Modal.Body style={{ maxHeight: '75vh', overflowY: 'auto' }}>
          {submitted ? (
            ...
            <form onSubmit={handleSubmit}>
              <div className="form-group mb-3"><label className="form-label fw-semibold">Full Name*</label>
                <input type="text" name="name" className="form-control" required pattern="[A-Za-z ]+" value={form.name} onChange={handleChange} /></div>
              <div className="form-group mb-3"><label className="form-label fw-semibold">Phone Number*</label>
                <input type="tel" name="phone" className="form-control" required pattern="^[0-9]{10}$" maxLength={10} value={form.phone} onChange={handleChange} /></div>
              <div className="form-group mb-3"><label className="form-label fw-semibold">Service*</label>
              ...
              <div className="form-group mb-3"><label className="form-label fw-semibold">Baby Born or Expecting?*</label>
              ...
              <div className="form-group mb-3"><label className="form-label fw-semibold">Hospital Name</label>
                <select name="hospitalName" className="form-select" value={form.hospitalName} onChange={handleChange}>
                  <option value="">Select Hospital</option>
                  {HOSPITALS.map(h => <option key={h} value={h}>{h}</option>)}
                </select></div>
              <div className="form-group mb-3"><label className="form-label fw-semibold">Baby Birth Stage</label>
              ...
              <div className="form-group mb-3"><label className="form-label fw-semibold">Baby Age</label>
              ...
              <div className="form-group mb-3"><label className="form-label fw-semibold">Baby&apos;s Current Weight</label>
              ...
              <div className="form-group mb-3"><label className="form-label fw-semibold">Current Address / Location*</label>
                <input type="text" name="address" className="form-control" required placeholder="House no., street, area, city" value={form.address} onChange={handleChange} /></div>
              <div className="form-group mb-3"><label className="form-label fw-semibold">Shift Type*</label>
              ...
              {shiftHoursOptions.length > 0 && (
                <div className="form-group mb-3"><label className="form-label fw-semibold">Shift Hours*</label>
              ...
              {shiftTimeOptions.length > 0 && (
                <div className="form-group mb-3"><label className="form-label fw-semibold">Shift Timing*</label>
              ...
              <div className="form-group mb-3"><label className="form-label fw-semibold">Care Start Date*</label>
                <input type="date" name="careStartDate" className="form-control" required min={today} value={form.careStartDate} onChange={handleChange} /></div>
              <div className="form-group mb-4"><label className="form-label fw-semibold">Service Duration*</label>
